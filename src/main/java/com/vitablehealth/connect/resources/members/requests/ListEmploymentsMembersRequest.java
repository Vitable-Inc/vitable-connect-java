...
@JsonDeserialize(builder = ListEmploymentsMembersRequest.Builder.class)
public final class ListEmploymentsMembersRequest {
    private final Optional<String> vitableOrganization;

    private final Map<String, Object> additionalProperties;

    private ListEmploymentsMembersRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListEmploymentsMembersRequest && equalTo((ListEmploymentsMembersRequest) other);
    }
    ...
    private boolean equalTo(ListEmploymentsMembersRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListEmploymentsMembersRequest other) {
        ...
        public ListEmploymentsMembersRequest build() {
            return new ListEmploymentsMembersRequest(vitableOrganization, additionalProperties);
        }
