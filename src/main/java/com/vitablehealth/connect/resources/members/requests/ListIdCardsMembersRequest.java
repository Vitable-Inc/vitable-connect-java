...
public final class ListIdCardsMembersRequest {
    ...
    private ListIdCardsMembersRequest(Optional<String> vitableOrganization, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListIdCardsMembersRequest && equalTo((ListIdCardsMembersRequest) other);
    }
    ...
    private boolean equalTo(ListIdCardsMembersRequest other) {
    ...
    public static final class Builder {
        ...
        public ListIdCardsMembersRequest build() {
            return new ListIdCardsMembersRequest(vitableOrganization, additionalProperties);
        }
