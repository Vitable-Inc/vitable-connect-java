...
@JsonDeserialize(builder = ListEnrollmentsMembersRequest.Builder.class)
public final class ListEnrollmentsMembersRequest {
    private final Optional<String> vitableOrganization;

    private final Map<String, Object> additionalProperties;

    private ListEnrollmentsMembersRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListEnrollmentsMembersRequest && equalTo((ListEnrollmentsMembersRequest) other);
    }
    ...
    private boolean equalTo(ListEnrollmentsMembersRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListEnrollmentsMembersRequest other) {
        ...
        public ListEnrollmentsMembersRequest build() {
            return new ListEnrollmentsMembersRequest(vitableOrganization, additionalProperties);
        }
