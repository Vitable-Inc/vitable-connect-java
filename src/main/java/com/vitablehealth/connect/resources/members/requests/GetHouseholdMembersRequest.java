...
@JsonDeserialize(builder = GetHouseholdMembersRequest.Builder.class)
public final class GetHouseholdMembersRequest {
    private final Optional<String> vitableOrganization;

    private final Map<String, Object> additionalProperties;

    private GetHouseholdMembersRequest(Optional<String> vitableOrganization, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetHouseholdMembersRequest && equalTo((GetHouseholdMembersRequest) other);
    }
    ...
    private boolean equalTo(GetHouseholdMembersRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GetHouseholdMembersRequest other) {
        ...
        public GetHouseholdMembersRequest build() {
            return new GetHouseholdMembersRequest(vitableOrganization, additionalProperties);
        }
