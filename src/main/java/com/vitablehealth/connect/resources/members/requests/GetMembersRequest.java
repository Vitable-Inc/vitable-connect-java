...
public final class GetMembersRequest {
    ...
    private GetMembersRequest(Optional<String> vitableOrganization, Map<String, Object> additionalProperties) {
    ...
    public static final class Builder {
        ...
        public GetMembersRequest build() {
            return new GetMembersRequest(vitableOrganization, additionalProperties);
        }
