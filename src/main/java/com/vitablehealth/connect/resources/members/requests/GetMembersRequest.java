...
public final class GetMembersRequest {
    ...
    private GetMembersRequest(Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetMembersRequest;
    }
    ...
    public static final class Builder {
        ...
        public GetMembersRequest build() {
            return new GetMembersRequest(additionalProperties);
        }
