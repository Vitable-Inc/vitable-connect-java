...
@JsonDeserialize(builder = GetEnrollmentsRequest.Builder.class)
public final class GetEnrollmentsRequest {
    private final Optional<String> vitableOrganization;

    private final Map<String, Object> additionalProperties;

    private GetEnrollmentsRequest(Optional<String> vitableOrganization, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetEnrollmentsRequest && equalTo((GetEnrollmentsRequest) other);
    }
    ...
    private boolean equalTo(GetEnrollmentsRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GetEnrollmentsRequest other) {
        ...
        public GetEnrollmentsRequest build() {
            return new GetEnrollmentsRequest(vitableOrganization, additionalProperties);
        }
