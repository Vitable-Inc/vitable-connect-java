...
@JsonDeserialize(builder = EnsurePayrollIntegrationEmailEmployersRequest.Builder.class)
public final class EnsurePayrollIntegrationEmailEmployersRequest {
    private final Optional<String> vitableOrganization;

    private final Map<String, Object> additionalProperties;

    private EnsurePayrollIntegrationEmailEmployersRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EnsurePayrollIntegrationEmailEmployersRequest
                && equalTo((EnsurePayrollIntegrationEmailEmployersRequest) other);
    }
    ...
    private boolean equalTo(EnsurePayrollIntegrationEmailEmployersRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(EnsurePayrollIntegrationEmailEmployersRequest other) {
        ...
        public EnsurePayrollIntegrationEmailEmployersRequest build() {
            return new EnsurePayrollIntegrationEmailEmployersRequest(vitableOrganization, additionalProperties);
        }
