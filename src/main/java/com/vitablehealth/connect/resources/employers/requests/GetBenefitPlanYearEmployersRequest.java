...
@JsonDeserialize(builder = GetBenefitPlanYearEmployersRequest.Builder.class)
public final class GetBenefitPlanYearEmployersRequest {
    private final Optional<String> vitableOrganization;

    private final Map<String, Object> additionalProperties;

    private GetBenefitPlanYearEmployersRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetBenefitPlanYearEmployersRequest
                && equalTo((GetBenefitPlanYearEmployersRequest) other);
    }
    ...
    private boolean equalTo(GetBenefitPlanYearEmployersRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GetBenefitPlanYearEmployersRequest other) {
        ...
        public GetBenefitPlanYearEmployersRequest build() {
            return new GetBenefitPlanYearEmployersRequest(vitableOrganization, additionalProperties);
        }
