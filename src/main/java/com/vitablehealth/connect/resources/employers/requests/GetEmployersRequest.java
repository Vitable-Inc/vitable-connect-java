...
@JsonDeserialize(builder = GetEmployersRequest.Builder.class)
public final class GetEmployersRequest {
    private final Optional<String> vitableOrganization;

    private final Map<String, Object> additionalProperties;

    private GetEmployersRequest(Optional<String> vitableOrganization, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetEmployersRequest && equalTo((GetEmployersRequest) other);
    }
    ...
    private boolean equalTo(GetEmployersRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GetEmployersRequest other) {
        ...
        public GetEmployersRequest build() {
            return new GetEmployersRequest(vitableOrganization, additionalProperties);
        }
