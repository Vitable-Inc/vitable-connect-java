...
@JsonDeserialize(builder = ListBenefitPlanYearsEmployersRequest.Builder.class)
public final class ListBenefitPlanYearsEmployersRequest {
    private final Optional<String> vitableOrganization;

    private final Map<String, Object> additionalProperties;

    private ListBenefitPlanYearsEmployersRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListBenefitPlanYearsEmployersRequest
                && equalTo((ListBenefitPlanYearsEmployersRequest) other);
    }
    ...
    private boolean equalTo(ListBenefitPlanYearsEmployersRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListBenefitPlanYearsEmployersRequest other) {
        ...
        public ListBenefitPlanYearsEmployersRequest build() {
            return new ListBenefitPlanYearsEmployersRequest(vitableOrganization, additionalProperties);
        }
