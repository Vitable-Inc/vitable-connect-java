...
public class VitableConnectBuilder {
     ...
     */
    public VitableConnectBuilder apiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }

    public VitableConnectBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public VitableConnectBuilder url(String url) {
     ...
     */
    public VitableConnectBuilder timeout(int timeout) {
     ...
     */
    public VitableConnectBuilder maxRetries(int maxRetries) {
     ...
     */
    public VitableConnectBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
     ...
     */
    public VitableConnectBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
     ...
     */
    public VitableConnectBuilder retryJitterFactor(double retryJitterFactor) {
     ...
     */
    public VitableConnectBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public VitableConnectBuilder logging(LogConfig logging) {
     ...
     */
    public VitableConnectBuilder addHeader(String name, String value) {
