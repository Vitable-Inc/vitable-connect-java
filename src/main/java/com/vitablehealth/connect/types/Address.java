...
public final class Address {
    ...
    /**
     * @return Two-letter state code (e.g. <code>CA</code>, <code>NY</code>).
     */
    @JsonProperty("state")
    ...
    public interface StateStage {
        /**
         * <p>Two-letter state code (e.g. <code>CA</code>, <code>NY</code>).</p>
         */
    ...
    public static final class Builder implements AddressLine1Stage, CityStage, StateStage, ZipcodeStage, _FinalStage {
        ...
        public Address build() {
            return new Address(addressLine1, addressLine2, city, state, zipcode, additionalProperties);
        }
