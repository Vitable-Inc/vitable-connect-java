...
public final class AddressRequest {
    ...
    /**
     * @return Two-letter USPS state or territory code, e.g. <code>PA</code>.
     */
    @JsonProperty("state")
    ...
    public interface AddressLine1Stage {
        ...
        Builder from(AddressRequest other);
    }
    ...
    public interface StateStage {
        /**
         * <p>Two-letter USPS state or territory code, e.g. <code>PA</code>.</p>
         */
    ...
    public static final class Builder implements AddressLine1Stage, CityStage, StateStage, ZipcodeStage, _FinalStage {
        ...
        public AddressRequest build() {
            return new AddressRequest(addressLine1, addressLine2, city, state, zipcode, additionalProperties);
        }
