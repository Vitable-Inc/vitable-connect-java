...
@JsonDeserialize(builder = EmployeeAddress.Builder.class)
public final class EmployeeAddress {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EmployeeAddress && equalTo((EmployeeAddress) other);
    }
    ...
    private boolean equalTo(EmployeeAddress other) {
    ...
    public interface AddressLine1Stage {
        ...
        Builder from(EmployeeAddress other);
    }
    ...
    public static final class Builder implements AddressLine1Stage, CityStage, StateStage, ZipcodeStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(EmployeeAddress other) {
        ...
        public EmployeeAddress build() {
            return new EmployeeAddress(addressLine1, addressLine2, city, state, zipcode, additionalProperties);
        }
