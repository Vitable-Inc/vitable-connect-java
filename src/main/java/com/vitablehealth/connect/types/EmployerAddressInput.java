...
@JsonDeserialize(builder = EmployerAddressInput.Builder.class)
public final class EmployerAddressInput {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EmployerAddressInput && equalTo((EmployerAddressInput) other);
    }
    ...
    private boolean equalTo(EmployerAddressInput other) {
    ...
    public interface AddressLine1Stage {
        ...
        Builder from(EmployerAddressInput other);
    }
    ...
    public static final class Builder implements AddressLine1Stage, CityStage, StateStage, ZipcodeStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(EmployerAddressInput other) {
        ...
        @java.lang.Override
        public EmployerAddressInput build() {
            return new EmployerAddressInput(addressLine1, addressLine2, city, state, zipcode, additionalProperties);
        }
