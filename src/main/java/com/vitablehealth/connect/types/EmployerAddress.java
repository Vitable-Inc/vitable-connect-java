...
@JsonDeserialize(builder = EmployerAddress.Builder.class)
public final class EmployerAddress {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EmployerAddress && equalTo((EmployerAddress) other);
    }
    ...
    private boolean equalTo(EmployerAddress other) {
    ...
    public interface AddressLine1Stage {
        ...
        Builder from(EmployerAddress other);
    }
    ...
    public static final class Builder implements AddressLine1Stage, CityStage, StateStage, ZipcodeStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(EmployerAddress other) {
        ...
        public EmployerAddress build() {
            return new EmployerAddress(addressLine1, addressLine2, city, state, zipcode, additionalProperties);
        }
