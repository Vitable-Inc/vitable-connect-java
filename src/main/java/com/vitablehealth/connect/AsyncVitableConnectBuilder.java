...
import com.vitablehealth.connect.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncVitableConnectBuilder {
    ...
    private String apiKey = System.getenv("VITABLE_CONNECT_API_KEY");
    ...
    /**
     * Sets apiKey.
     * Defaults to the VITABLE_CONNECT_API_KEY environment variable.
     */
    public AsyncVitableConnectBuilder apiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }

    public AsyncVitableConnectBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public AsyncVitableConnectBuilder url(String url) {
     ...
     */
    public AsyncVitableConnectBuilder timeout(int timeout) {
     ...
     */
    public AsyncVitableConnectBuilder maxRetries(int maxRetries) {
     ...
     */
    public AsyncVitableConnectBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
     ...
     */
    public AsyncVitableConnectBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
     ...
     */
    public AsyncVitableConnectBuilder retryJitterFactor(double retryJitterFactor) {
     ...
     */
    public AsyncVitableConnectBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncVitableConnectBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncVitableConnectBuilder addHeader(String name, String value) {
    ...
    public AsyncVitableConnect build() {
        if (apiKey == null) {
            throw new RuntimeException(
                    "Please provide apiKey or set the VITABLE_CONNECT_API_KEY environment variable.");
        }
        validateConfiguration();
        return new AsyncVitableConnect(buildClientOptions());
    }
}
